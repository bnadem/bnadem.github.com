      ...
      _createClass(DashboardComponent, [{
        ...
        value: function NewMapChartModel(option) {
          ...
          this.zone.runOutsideAngular(function () {
            ...
            polygonSeries.data = _this12.countries.map(function (item) {
              return {
                id: item.code,
                value: item[option]
              };
            });
            _this12.myChart = chart;
          });
          return;
        }
      }]);
      ...
      _createClass(CountupComponent, [{
        ...
        value: function ngOnInit() {
          ...
          setInterval(function () {
            _this13.timer = _this13.dhms(Math.floor(new Date().getTime() - _this13.oldDate.getTime()));
          }, 1000);
        }
      }, {
        key: "dhms",
